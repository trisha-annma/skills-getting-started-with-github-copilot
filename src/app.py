...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice fundamentals and play competitive basketball games",
    ...
    "Drama Club": {
        "description": "Build acting skills and perform in school theater productions",
        "schedule": "Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["james@mergington.edu", "amelia@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice critical thinking and public speaking through structured debates",
